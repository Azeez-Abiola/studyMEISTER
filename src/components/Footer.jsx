  ...
  return (
    <footer className="bg-gray-100 py-6 w-full">
      <div className="max-w-[1440px] mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start md:ml-[60px] pt-16 pl-[48px]">
          <div className="w-full md:w-1/3 lg:w-1/4 mb-8 md:mb-0">
            ...
            <p className="font-inter font-semibold text-gray-600 mb-2 text-sm leading-[1.4] mb-8 max-w-[314px] md:max-w-[280px]">
              Simplify your research journey with tools that help you organize, draft, and refine your articles effortlessly.
            </p>
