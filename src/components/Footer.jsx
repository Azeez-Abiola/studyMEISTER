  ...
  return (
    <footer className="bg-gray-100 py-6 w-full">
      <div className="max-w-[1440px] mx-auto lg:px-4">
        <div className="flex flex-wrap justify-between items-start md:ml-[60px] pt-16 lg:pl-[48px] md:pl-2 pl-7">
          <div className="w-full md:w-1/3 lg:w-1/4 mb-8 md:mb-0">
            ...
            />
            <p className="font-inter font-semibold text-gray-600 mb-2 text-sm leading-[1.4] mb-8 max-w-[314px] md:max-w-[280px]">
              Simplify your research journey with tools that help you organize,
              draft, and refine your articles effortlessly.
            </p>
          ...
          <div className="flex flex-col md:flex-row md:w-2/3 lg:w-3/5 md:justify-end">
            ...
            <div className="w-full md:w-1/4 mb-8 md:mb-0">
              <h3 className="font-inter text-base font-bold mb-2">
                Contact us
              </h3>
              <ul className="font-inter text-gray-600 text-sm space-y-4">
