...
const Header = () => {
  ...
  return (
    <header className="bg-white p-4 mb-2">
      <div className="flex items-center justify-between mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        <img src={"./logo.png"} alt="StudyMeister Logo" width={150} height={42} className="z-20 ml-19" />
        <button
