...
const Hero = () => {
  ...
  return (
    <section
      className={`relative p-4 sm:p-8 bg-white flex flex-col md:flex-row justify-between xl:gap-10 items-center mt-24 md:mt-2 max-w-[1322px] mx-auto
                md:p-8 lg:p-16
                min-[775px]:mb-[12rem]
                min-[768px]:mt-20
                min-[972px]:mt-2
                ...
                max-[639px]:mb-8
                [@media(min-width:3840px)]:max-w-[1922px]`}
      style={{
        zIndex: 0,
      }}
    >
      ...
      >
        <h1
          className={`text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-gray-800 mb-4 sm:mb-8
                      min-[768px]:text-2xl
                      min-[820px]:text-3xl
                      [@media(width=834px)]:mt-6`}
        >
          <span className="font-semibold">
            Write articles quickly with Study
          </span>
          <span className="font-bold">MEISTER</span>
        </h1>
        <p
          className={`mt-4 sm:mt-8 text-gray-500 font-medium text-sm sm:text-base
                     min-[768px]:text-sm
                     min-[820px]:text-base
                     min-[1024px]:pr-8
                     min-[1072px]:pr-0`}
        >
          <div
            className={`[@media(width=3840px)]:w-[466px] [@media(width=1920px)]:w-[466px] [@media(width=1920px)]:text-[16px] [@media(width=1440px)]:w-[466px] [@media(width=834px)]:w-[392px] [@media(width=834px)]:text-[14px] min-[1400px]:max-[3839px]:w-[466px]`}
          >
            Streamline your writing process with tools designed to help you
            organize ideas, generate content, and refine your research
            efficiently. Create high-quality articles with ease, tailored to
            your academic needs.
          </div>
        </p>
        <button
          className={`w-full sm:w-full md:w-auto px-4 sm:px-6 md:px-8 lg:px-10 py-2 mt-6 text-white bg-[#3D5A80] rounded-[3px] text-sm sm:text-base hover:bg-[#1E3A5F] border-2 border-[#3D5A80] hover:border-transparent transition-all duration-300 ease-in-out hover:shadow-[0_4px_8px_rgba(0,0,0,0.3)]
                          min-[768px]:text-sm
                          min-[820px]:text-base
                          max-[456px]:w-[350px] max-[456px]:h-[40px]
      ...
      >
        <img
          ...
          className={`w-full h-auto max-w-[100%] sm:max-w-[110%] mx-auto
                    ...
                    max-[456px]:w-[369.92px] max-[456px]:h-[338.83px] max-[456px]:mt-[-40px] max-[456px]:mb-[-110px]`}
          style={{
